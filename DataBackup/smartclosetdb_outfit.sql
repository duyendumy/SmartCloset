...
CREATE TABLE `outfit` (
  ...
  PRIMARY KEY (`id`),
  KEY `FKhnmlc9h8ogipmtyuuvsw9gpjo` (`id_closet`),
  CONSTRAINT `FKhnmlc9h8ogipmtyuuvsw9gpjo` FOREIGN KEY (`id_closet`) REFERENCES `closet` (`id`)
...
INSERT INTO `outfit` VALUES (1,1,1),(2,1,1),(3,1,1),(4,1,1),(5,1,1),(6,1,1),(7,1,1),(8,1,1),(9,1,6),(10,1,6),(11,1,6),(12,1,6);
